...
\begin{center}
  \begin{tikzpicture}[point/.style={circle,inner sep=0pt,minimum size=2pt,fill=red},
    ...
    \draw[<-,color=green!100,thick] (cw nodes below-4-3) -- (cw nodes south-1-2);
    \draw[<-,color=green!100,thick] (filter nodes below-4-3) -- (filter nodes south-1-2);
    \draw[<-,color=green!100,thick] (acq nodes below-4-3) -- (acq nodes south-1-2);
    \draw[<-,color=green!100,thick] (track nodes below-4-3) -- (track nodes south-1-2);
    \draw[-,color=green!100,thick] (cw nodes below-4-3) -- (nap nodes-3-1);
    \draw[>->,color=green!100,thick] (nap nodes-3-1) -- node[above,font=\scriptsize,color=black] {IRQ} (stm nodes-3-1);
